...
import inference.GibbsSampling;
import parser.XMLBIFParser;

public class MyGibbsInferencer {
	public static void main(String[] args) throws IOException, ParserConfigurationException, SAXException {
		...
		GibbsSampling lw = new GibbsSampling(sampleNumber);
		...
		System.out.println("---------- End of the Gibbs Sampling! ----------");
	}
