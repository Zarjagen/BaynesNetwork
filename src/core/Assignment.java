...
/**
 * An Assignment is a list of RandomVariables and their corresponding values
 * (Objects). Currently implementation uses a LinkedHashMap to get a predictable
...
public class Assignment extends LinkedHashMap<RandomVariable, Object> {
	...
	/**
	 * Set the value of the given RandomVariable stored in this Assignment. This
	 * method is an alias for {@link LinkedHashMap#put}.
	 */
