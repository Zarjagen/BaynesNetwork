...
/**
 * Defines the interface supported by implementations of the inference
 * algorithms for Bayesian Networks.
 */
public interface Inferencer {

	/*
	 * Returns the Distribution of the query RandomVariable X given evidence
	 * Assignment e, using the distribution encoded by the BayesianNetwork bn.
	 ...
	 * as to what an inferencer should do (namely, compute a posterior
	 * distriubution.
	 */
