...
public class BIFParser {
	 ...
	 * InputStream. Invokes automatically-generated constructor that takes a
	 * Lexer as parameter.
	 */
	...
	/**
	 * Parse and return a BayesianNetwork from this BIFParser's input. This
	 * method wraps a call to the basic Bison-generated {@link BIFParser#parse}
	 * method.
	 */
	...
	/**
	 * Test driver for BIFParser: Parses given file or stdin, prints resulting
	 * BN to stdout.
	 */
	...
	/**
	 * Recursively traverses parents in the order they were declared (ie., their
	 * order in the list), iterating through each of their values, assigning
	 * probabilities from ptvalues at the leaves.
	 */
	protected void defineProbabilityTableEntry(CPT cpt, Assignment x, List<RandomVariable> parents,
