...
/**
 * A Set implementation backed by an ArrayList. This is good for more or less
 * immutable sets, but isn't part of standard Java.
 */
public class ArraySet<E> extends AbstractSet<E> {
	...
	/**
	 * Construct and return a new ArraySet with some default initial capacity
	 * (in fact, the default initial capacity of an ArrayList, if you care).
	 */
	public ArraySet() {
		super();
	 ...
	 * collection and with capacity as needed to whole them all. Per the
	 * contract of the Set interface in the Collections Framework, duplicate
	 * elements (according to equals()) are not added mulitple times.
	 */
